    ...
    <div class="row">
        <div class="col margin-top-1rem margin-bottom-1rem">
            ...
            <div class="text-align-left">
                ...
                <p>ソフトウェアエンジニア。<br></p>
                <p>2015年に大学卒業後、フリーランス、スタートアップ、受託開発会社等を経て、現在は自社サービスを運営する会社にて所属しています。<br>インフラ・フロントエンド・サーバーサイドの幅広な開発経験やリードエンジニアとしてのチームマネジメント・リーディングの経験等があります。<br>レガシーなアプリケーションへの対峙、開発チームの立ち上げ、プロジェクト進行、Goやコンテナ技術を使ったアプリケーション開発が得意です。<br></p>
                <p><strong><em>「組織・ソフトウェアの価値を長期的に向上させる」</em></strong>ということに興味を持っており、組織・ソフトウェアの成長、進化に楽しみを感じています。<br>ソフトウェアエンジニアとしてソフト・ハードのスキルを発揮し、自らが関わるプロダクトの成長に貢献していきたいと日々思っています。<br></p>
