        ...
        <div class="col margin-top-1rem margin-bottom-1rem">
            ...
            <div class="text-align-left">
                ...
                <div class="margin-top-3rem">
                    ...
                    <p class="font-size-small">受託と自社サービスの両方の開発に携わりました。チーム開発でプロダクトを磨く姿勢が身につきました。</p>
                    <br>
                    <p><em>某スタートアップ/ソフトウェアエンジニア</em><br><span class="font-size-small">2016-2017</span></p>
                    <p class="font-size-small">プロダクトの価値をスピーディーに提供することを重視してソフトウェアエンジニアとしての最初のキャリアをスタートさせました。デザインや機能といった品質の追求姿勢、プロダクト成長に関連する数字への意識が身につきました。</p>
                    <br>
                    <p><em>フリーランス/マークアップエンジニア</em><br><span class="font-size-small">2015-2016</span></p>
                    <p class="font-size-small">WordpressのコーディングやWebデザインをやっていました。受託の仕事を探して営業したこともありました。相手の要件を汲み取るコミュニケーションを身につけました。</p>
					</p>
                </div>
                <div class="margin-top-3rem">
                    <h2>資格</h2>
